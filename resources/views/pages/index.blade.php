    ...
    <div>
        ...
        >
            <main class="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                <div
                    class="flex-1 rounded-ee-lg rounded-es-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-ss-lg lg:rounded-ee-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]"
                >
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                                    <span class="relative bg-white py-1 dark:bg-[#161615]">
                                        ...
                                        >
                                            <span
                                                class="h-1.5 w-1.5 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]"></span>
                                        </span>
                                    </span>
                            <span>
                                        Read the
                        ...
                        <li
                            class="relative flex items-center gap-4 py-2 before:absolute before:start-[0.4rem] before:top-0 before:bottom-1/2 before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]"
                        >
                                    <span class="relative bg-white py-1 dark:bg-[#161615]">
                                        <span
                                            class="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-[#e3e3e0] bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-[#3E3E3A] dark:bg-[#161615]"
                ...
                >
                    ...
                    Light Mode 12 SVG
                    <svg
                        class="relative -ms-8 -mt-[4.9rem] w-[448px] max-w-none lg:ms-0 lg:-mt-[6.6rem] dark:hidden"
                        viewBox="0 0 440 376"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                    ...
                    Dark Mode 12 SVG
                    <svg
                        class="relative -ms-8 -mt-[4.9rem] hidden w-[448px] max-w-none lg:ms-0 lg:-mt-[6.6rem] dark:block"
                        viewBox="0 0 440 376"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                    ...
                    <div
                        class="absolute inset-0 rounded-t-lg shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-e-lg lg:rounded-t-none dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]"
                    ></div>
                </div>
            </main>
        </div>
